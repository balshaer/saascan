...
import { ENGLISH_HORIZONTAL_TABLE_ANALYSIS_PROMPT } from '../config/analysis_prompts';
...
const useSingleAnalysis = () => {
  ...
  const handleAnalyze = useCallback(async () => {
    ...
    try {
      ...
      // Use the English horizontal table analysis prompt
      const prompt = ENGLISH_HORIZONTAL_TABLE_ANALYSIS_PROMPT.replace('{SAAS_CONCEPT}', input);
