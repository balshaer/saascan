              ...
              <Card className="w-full shadow-lg overflow-hidden">
                <CardHeader className="pb-4">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <p className="text-sm mb-2" style={{ color: cssVars.textSecondary }}>
                        <ScrambleIn
                          ref={(el) => {
                      ...
                      {result.summary && (
                        <p className="text-sm italic" style={{ color: cssVars.textPrimary }}>
                          <ScrambleIn
                            ref={(el) => {
                ...
                <CardContent>
                  ...
                  <div className="mb-6">
                    ...
                    >
                      <p className="text-sm" style={{ color: cssVars.textPrimary }}>
                        {isExpanded
                          ? result.input
